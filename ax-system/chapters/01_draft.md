...
같은 절차 문서가 어떤 조직에서는 구성원에게 능력을 실어주고(enabling), 어떤 조직에서는 구성원을 소외시킨다(coercive). 논문 자체의 표현으로는, 관료제를 소외시키는 것으로 보는 평가와 능력을 실어주는 것으로 보는 평가가 왜 엇갈리는지를 조화시키려는 시도다. 그러니 "절차를 줄여라"는 처방은 애초에 잘못된 축을 잡고 있다. 줄이고 늘리는 축으로는 답이 나오지 않는다. 물어야 할 것은 어느 유형으로 만드느냐다. 두 유형을 가르는 설계 특성까지 들어가지는 않겠다. 원문 대조가 끝나지 않아 확인 안 된 것을 아는 척하지 않으려 한다.

대신 이 논문에서 가져올 문장이 따로 있다. enabling 형식화가 무엇인지에 대한 정의다.

> **현장의 지식과 경험을 중앙의 목표를 위해 동원하려는 시도.**

잠시 멈추고 순서를 보자. 현장의 지식과 경험이 먼저 있다. 그것을 중앙이 동원한다. 지식의 출처는 아래고, 목표의 출처는 위다. 형식화란 그 둘을 잇는 장치다.

이 책이 앞에서 세운 교정 — 바텀업이 씨앗을 만들고 탑다운은 거두는 체계를 만든다 — 은 1996년에 이미 이렇게 적혀 있었던 셈이다. 30년 전 조직 이론이 AI 에이전트를 예견했을 리는 없다. 그래서 오히려 신뢰가 간다. 이건 조직이 현장의 것을 자산으로 바꾸는 오래된 문제이고, AI는 그 문제의 규모와 속도만 키웠다.

여기에 하나를 얹으면 처방이 구체화된다. 클라인과 소라가 1996년 『Academy of Management Review』 21권 4호에 실은 동료평가 논문은 "파일럿은 성공했는데 확산이 안 된다"의 고전적 답을 준다. 이들이 말하는 **구현 풍토(implementation climate)** 란 대상 구성원들이 그 혁신의 사용이 얼마나 보상받고, 지원받고, 기대되는지에 대해 공유하는 인식이다. 여기에 **혁신-가치 정합** — 그 혁신이 자기 가치를 밀어주는지 깎아내리는지에 대한 사용자의 인식 — 이 붙는다. 두 조건을 곱하면 결과가 넷으로 갈린다. 저항, 회피, 순응, 헌신. 이 스펙트럼에서 순응과 헌신이 다르다는 점을 기억해두자. **사용률만 보는 지표는 순응까지만 측정한다.** 앞 절에서 사용률을 목표로 삼지 말자고 한 이유가 여기서 이론적으로 채워진다.

진단 도구로도 쓸 만하다. "쓰라고 했는데 안 쓴다"는 상황이 오면 원인 후보가 둘뿐이다. 풍토가 약하거나, 가치가 안 맞거나. 앞이라면 보상·지원·기대 중 무엇이 빠졌는지 짚으면 되고, 뒤라면 도구를 더 홍보해봐야 소용이 없다. 위가 공급해야 하는 것의 정체도 여기서 목록을 얻는다. 보상받는가, 지원받는가, 기대되는가. 이 셋은 전부 조건이고 제도다. 과제 목록은 여기 없다.
